...
const IntroBox: React.FC = () => {
    return (
        <div className='relative h-full w-full flex flex-col rounded-2xl md:col-span-3 p-5 overflow-hidden row-span-1'>
            <div className='absolute inset-0 bg-white opacity-15 rounded-2xl' />
            <div className='flex md:justify-end justify-center items-center relative z-10 my-6 md:my-0'>
                <l-mirage
                    size="80"
                    speed="2.5"
                    color="orange"
