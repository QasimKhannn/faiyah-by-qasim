...
const SocialsBox: React.FC = () => {
    return (
        <div className='relative h-full w-full flex flex-col rounded-2xl p-5 justify-center items-center overflow-hidden'>
            <div className='absolute inset-0 bg-white opacity-20 rounded-2xl' />
            <div className='flex justify-center items-center relative z-10 gap-10'>
